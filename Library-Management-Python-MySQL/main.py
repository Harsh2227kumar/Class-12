...
root = Tk()
root.title("Library Management Sysytem")
...
background_image =Image.open("F:\Python\Projects\Library-Management-Using-Python-and-MySQL-main\Library-Management-Python-MySQL\lib.jpg")
...
headingLabel = Label(headingFrame1, text="Welcome to \n Books Library \n Samsidh Tuli Public School", bg='black', fg='white', font=('Courier',15))
